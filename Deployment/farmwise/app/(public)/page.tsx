...
export default function HomePage() {
  ...
  // Satellite Farm Insights Widget - NEW
  ...
  const featureItems = features.map((feature, index) => (
    <motion.div key={feature.title} variants={itemVariant}>
      <Card shadow="md" className={classes.featureCard} padding="xl">
        ...
        <Stack mt="lg" gap="md">
          {index === 0 && (
            <>
              {/* Add consistent bottom margin to selectors */}
  ...
  return (
    <>
      ...
      <motion.section
        ...
        variants={sectionVariant}
      >
        <Container size="lg"> {/* Use lg container for consistency */}
            <Title order={2} className={classes.sectionTitle} ta="center">
            ...
            <SimpleGrid cols={{ base: 1, sm: 2, lg: 3 }} spacing="xl" mt="xl">
                {testimonials.map((testimonial) => (
                    <motion.div key={testimonial.author} variants={itemVariant} style={{ height: '100%' }}>
                        <Paper
                            withBorder
                            shadow="md"
                            p="xl"
                            radius="md"
                            className={classes.testimonialCard} // Add a specific class if needed
                            style={{ height: '100%' }}
                        >
